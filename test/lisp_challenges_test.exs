defmodule LispChallangesTest do
  ...
  test "p08 test" do
    assert LispChallanges.test_p08("a a a a b c c a a d e e e e" |> String.split(" ")) ==
             "a b c a d e" |> String.split(" ")
  end

  test "p09 test" do
    assert LispChallanges.test_p09("a a a a b c c a a d e e e e" |> String.split(" ")) == [
             ["a", "a", "a", "a"],
             ["b"],
             ["c", "c"],
             ["a", "a"],
  ...
  test "p09 test with mixed elements" do
    assert LispChallanges.test_p09(["a", "b", "b", "c", "a", "a", "d", "e", "e"]) == [
             ["a"],
             ["b", "b"],
             ["c"],
             ["a", "a"],
  ...
  test "p10 test : run-length encoding data compression method" do
    assert LispChallanges.test_p010(["a", "b", "b", "c", "a", "a", "d", "e", "e"]) == [
             [1, "a"],
             [2, "b"],
             [1, "c"],
             [2, "a"],
  ...
  test "p11 test : run-length encoding with single element" do
    assert LispChallanges.test_p11(["a", "b", "b", "c", "a", "a", "d", "e", "e"]) == [
             ["a"],
             [2, "b"],
             ["c"],
             [2, "a"],
  ...
  test "p12 test : run-length decoding" do
    assert LispChallanges.test_p12([["a"], [2, "b"], ["c"], [2, "a"], ["d"], [2, "e"]]) == [
             "a",
             "b",
             "b",
             "c",
  ...
  test "p14 : replicate 1 " do
    assert LispChallanges.test_p14(["a", "b", "c", "d"], 2) == [
             "a",
             "a",
             "b",
             "b",
  ...
  test "p15 : replicate 3 " do
    assert LispChallanges.test_p14(["a", "b", "c", "d"], 3) == [
             "a",
             "a",
             "a",
             "b",
  ...
  test "p16 : Drop every 3rd element from a list" do
    assert LispChallanges.test_p16(["a", "b", "c", "d", "e", "f", "g", "h", "i", "k"], 3) == [
             "a",
             "b",
             "d",
             "e",
  ...
  test "p16 : Drop every 2nd element from a list" do
    assert LispChallanges.test_p16(["a", "b", "c", "d", "e", "f", "g", "h", "i", "k"], 2) == [
             "a",
             "c",
             "e",
             "g",
  ...
  test "p16 : Drop every 4th element from a list" do
    assert LispChallanges.test_p16(["a", "b", "c", "d", "e", "f", "g", "h", "i", "k"], 4) == [
             "a",
             "b",
             "c",
             "e",
  ...
  test "p16 : Drop every 5th element from a list" do
    assert LispChallanges.test_p16(["a", "b", "c", "d", "e", "f", "g", "h", "i", "k"], 5) == [
             "a",
             "b",
             "c",
             "d",
  ...
  test "p17 : Split a list into two parts; the length of the first part is given" do
    assert LispChallanges.test_p17(["a", "b", "c", "d", "e", "f", "g", "h", "i", "k"], 3) ==
             {["a", "b", "c"], ["d", "e", "f", "g", "h", "i", "k"]}
  end
  ...
  test "p18 : Extract a slice from a list" do
    assert LispChallanges.test_p18(["a", "b", "c", "d", "e", "f", "g", "h", "i", "k"], 3, 7) == [
             "c",
             "d",
             "e",
             "f",
  ...
  test "p18 : Extract a slice from a list with start index 1" do
    assert LispChallanges.test_p18(["a", "b", "c", "d", "e", "f", "g", "h", "i", "k"], 1, 3) == [
             "a",
             "b",
             "c"
           ]
  ...
  test "p18 : Extract a slice from a list with end index equal to list length" do
    assert LispChallanges.test_p18(["a", "b", "c", "d", "e", "f", "g", "h", "i", "k"], 8, 10) == [
             "h",
             "i",
             "k"
           ]
  ...
  test "p19 rotate a list 3 times" do
    assert LispChallanges.test_p19(["a", "b", "c", "d", "e", "f", "g", "h"], 3) == [
             "d",
             "e",
             "f",
             "g",
  ...
  test "p19 rotate a list 1 time" do
    assert LispChallanges.test_p19(["a", "b", "c", "d", "e", "f", "g", "h"], 1) == [
             "b",
             "c",
             "d",
             "e",
  ...
  test "p19 rotate a list 0 times" do
    assert LispChallanges.test_p19(["a", "b", "c", "d", "e", "f", "g", "h"], 0) == [
             "a",
             "b",
             "c",
             "d",
  ...
  test "p21 : Insert an element at the 2nd position" do
    assert LispChallanges.test_p21("alfa", ["a", "b", "c", "d"], 2) == [
             "a",
             "alfa",
             "b",
             "c",
  ...
  test "p21 : Insert an element at the 1st position" do
    assert LispChallanges.test_p21("alfa", ["a", "b", "c", "d"], 1) == [
             "alfa",
             "a",
             "b",
             "c",
  ...
  test "valid tree" do
    ...
    assert Binarytrees.is_tree(tree) == true
  end
  ...
  test "invalid tree with missing left key" do
    ...
    assert Binarytrees.is_tree(invalid_tree) == false
  end
